        ...
        <div className="relative w-full max-w-[656px] px-6 md:px-0 flex flex-col">
          ...
          <section className="mt-[32px] md:mt-[26px] flex flex-col items-center">
            ...
            <div className="w-[326px] flex flex-col">
              ...
              <Input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="set a strong password" className="w-full h-[30px] rounded-[5px] bg-[#F4F4F4] border border-[#0D1717] [border-width:0.5px] px-3 text-[12px] leading-[1.3em] text-[#0D1717] placeholder:text-[#959595]" />
            </div>
