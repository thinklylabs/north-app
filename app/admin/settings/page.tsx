      ...
      <div className="px-6 md:px-10 pb-[140px]">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-[10px] bg-white border-[#171717]/20 border-[0.5px] shadow-[0_6px_20px_rgba(13,23,23,0.08)]">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-[#171717]/20 rounded-[5px] text-[12px] focus:outline-none focus:ring-2 focus:ring-[#1DC6A1]/20"
                  />
                </div>
