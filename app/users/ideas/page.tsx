      ...
      <div className="px-6 md:px-10 pb-24">
        ...
        <div className="mt-[30px] flex items-center justify-between">
          ...
          <Button
            ...
            //   setFeedbackFor('idea');
            // }}
            className="h-[27px] rounded-[5px] bg-gray-400 text-black px-3 py-0 text-[10px] cursor-pointer group opacity-40"
          >
            <span className="group-hover:hidden">Feedback</span>
            <span className="hidden group-hover:inline">Coming Soon</span></Button>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                {/* Read-only content - ideas are now uneditable */}
                <div className="px-5 py-4 grid grid-cols-1 gap-3">
                  <div>
                    <div className={`mb-1.5 text-[12px] text-[#0D1717] ${oldStandard.className}`}>Topic</div>
                    <div className={`w-full text-[12px] text-[#0D1717] rounded-[8px] border-[#171717]/20 border-[0.5px] bg-[#F6F2EC] px-3 py-2.5 min-h-[38px] flex items-center`}>
                      {editTopic || 'No topic'}
                    </div>
                    {/* Old editable input - commented out
                    <input
                      value={editTopic}
                  ...
                  <div>
                    ...
                    <div className={`w-full min-h-[100px] text-[12px] leading-[1.6em] text-[#0D1717] rounded-[10px] border-[#171717]/20 border-[0.5px] bg-[#F6F2EC] p-3 whitespace-pre-wrap`}>
                      {editEq || 'No EQ'}
                    </div>
                    {/* Old editable textarea - commented out
                    <textarea
                      value={editEq}
              ...
              <div className="px-5 pb-4 flex flex-wrap items-center gap-2 flex-shrink-0 border-t border-[#171717]/10 border-[0.5px] bg-[#FCF9F5]">
                {/* Save button removed since ideas are now read-only
                <Button
                  type="button"
