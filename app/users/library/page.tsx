        ...
        <div className="mt-5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Button
              ...
              variant="outline"
              className={`h-[27px] rounded-[5px] px-3 py-0 text-[10px] cursor-pointer border-[0.5px] ${activeTab === "context"
            ...
            <Button
              ...
              className={`h-[27px] rounded-[5px] px-3 py-0 text-[10px] cursor-pointer ${activeTab === "sources"
                  ? "bg-[#1DC6A1] text-white hover:bg-[#19b391]"
                  : "bg-[#e5e7eb] text-[#0D1717]/80 hover:bg-[#d1d5db]"
                }`}
            >
              ...
              i === 0 ? (
                ...
                >
                  ...
                  <Button
                    ...
                    className="h-[27px] rounded-[5px] bg-[#1DC6A1] hover:bg-gray-400 text-white px-3 py-0 text-[10px] cursor-pointer group opacity-40"
                    // disabled={slackConnecting}
                  >
                    {/* {slackConnecting ? 'Connecting…' : 'Connect'} */}
                    <span className="group-hover:hidden">Connect</span>
                    <span className="hidden group-hover:inline">Disabled</span>
                  </Button>
                </div>
              ) : i === 3 ? (
                <div
                ...
                >
                  ...
                  <div className="flex justify-center">
                    <span className="text-[16px] leading-[1.3em] text-white/90 text-center">Coming Soon...</span>
                  </div>
                  <Button
                    type="button"
                    onClick={openModal}
                    className="h-[27px] rounded-[5px] bg-[#1DC6A1] hover:bg-[#19b391] text-white px-3 py-0 text-[10px] cursor-pointer opacity-40"
                  >
                    Connect
                  </Button>
                </div>
                ...
                <div className="mt-5 space-y-3">
                  {substackUrls.map((url, index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      />
                      <div className={`w-[30px] h-[30px] rounded-[5px] flex items-center justify-center ${validatedUrls[index] ? 'bg-[#1DC6A1]' : 'bg-[#7FA9A1]'
                        }`}>
                        <svg
                          width="11"
                          height="8"
                  ...
                  {manualRssUrls.map((url, index) => (
                    <div key={index} className="flex items-center gap-2">
                      <input
                        ...
                        className="flex-1 h-[30px] rounded-[5px] border-[#0D1717]/15 bg-[#F4F4F4] px-3 text-[12px] outline-none focus:ring-2 focus:ring-[#1DC6A1]/30"
                      />
                      <div className={`w-[30px] h-[30px] rounded-[5px] flex items-center justify-center ${manualRssValidatedUrls[index] ? 'bg-[#1DC6A1]' : 'bg-[#7FA9A1]'
                        }`}>
                        <svg
                          width="11"
                          height="8"
